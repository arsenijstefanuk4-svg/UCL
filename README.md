        ...
        <section id="pd">
            ...
            <div class="rules-grid">
                ...
                <div class="rule-card searchable" onclick="copyCardText(this)">
                    ...
                    <div class="card-desc">
                        Ждать удара можно максимум <strong>2 секунды</strong>, вы можете случайно выйти за рамки времени и будет только предупреждение, но если вы злоупотребляете этим то получите фол. Это касается и демпси ролла - вы не можете злоупотреблять им больше чем <strong>2,5 секунды</strong>.<br><br>
